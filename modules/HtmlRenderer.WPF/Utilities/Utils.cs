...
namespace TheArtOfDev.HtmlRenderer.WPF.Utilities
{
    ...
    internal static class Utils
    {
        ...
        /// </summary>
        public static RPoint Convert(Point p) => new RPoint(p.X, p.Y);
        ...
        /// </summary>
        public static Point Convert(RPoint p) => new Point(p.X, p.Y);

        /// <summary>
        /// Convert from core point to WPF point.
        /// </summary>
        public static Point ConvertRound(RPoint p) => new Point((int)p.X, (int)p.Y);

        /// <summary>
        /// Convert from WPF size to core size.
        /// </summary>
        public static RSize Convert(Size s) => new RSize(s.Width, s.Height);

        /// <summary>
        /// Convert from core size to WPF size.
        /// </summary>
        public static Size Convert(RSize s) => new Size(s.Width, s.Height);

        /// <summary>
        /// Convert from core point to WPF point.
        /// </summary>
        public static Size ConvertRound(RSize s) => new Size((int)s.Width, (int)s.Height);

        /// <summary>
        /// Convert from WPF rectangle to core rectangle.
        /// </summary>
        public static RRect Convert(Rect r) => new RRect(r.X, r.Y, r.Width, r.Height);

        /// <summary>
        /// Convert from core rectangle to WPF rectangle.
        /// </summary>
        public static Rect Convert(RRect r) => new Rect(r.X, r.Y, r.Width, r.Height);

        /// <summary>
        /// Convert from core rectangle to WPF rectangle.
        /// </summary>
        public static Rect ConvertRound(RRect r) => new Rect((int)r.X, (int)r.Y, (int)r.Width, (int)r.Height);
