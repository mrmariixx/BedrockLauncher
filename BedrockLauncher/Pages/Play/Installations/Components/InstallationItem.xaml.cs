...
namespace BedrockLauncher.Pages.Play.Installations.Components
{
    ...
    public partial class InstallationItem : UserControl
    {
        ...
        private void Play_Click(object sender, RoutedEventArgs e)
        {
            ...
            MainDataModel.Default.Play(MainDataModel.Default.Config.CurrentProfile, installation, KeepLauncherOpen, false);
        }
        ...
        private void More_Click(object sender, RoutedEventArgs e)
        {
            Button button = sender as Button;
            var installation = button.DataContext as BLInstallation;
            (this.Tag as Pages.Play.Installations.InstallationsScreen).InstallationsList.SelectedItem = installation;
