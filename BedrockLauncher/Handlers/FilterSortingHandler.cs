...
namespace BedrockLauncher.Handlers
{
    public class FilterSortingHandler
    {
        ...
        public static bool Filter_VersionList(object obj)
        {
            ...
            {
                if (v.PackageType == PackageType.UWP && !Properties.LauncherSettings.Default.ShowUWP) return false;
                if (v.PackageType == PackageType.GDK && !Properties.LauncherSettings.Default.ShowGDK) return false;
